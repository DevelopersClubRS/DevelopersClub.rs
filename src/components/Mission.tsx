        ...
        >
          <div className="max-w-3xl mx-auto text-center mb-12 md:mb-20">
            <motion.h2
              ...
              viewport={{ once: true }}
              className="text-3xl md:text-5xl font-bold mb-4 md:mb-6 bg-clip-text text-transparent bg-gradient-to-b from-[#e4f1f7] via-[#89c2d9] to-[#61a5c2] [-webkit-text-stroke:1px_rgba(255,255,255,0.1)] [text-shadow:0_1px_2px_rgba(0,0,0,0.2),0_1px_15px_rgba(97,165,194,0.3)] leading-[1.1]"
            >
              Naša Vizija
            </motion.h2>
            <motion.p
